...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  String formatDate(dynamic dateRaw) {
    ...
    else if (dateRaw is String) date = DateTime.tryParse(dateRaw);
  ...
  Future<void> _pickAndUploadImage() async {
    ...
    try {
      ...
      final ref = FirebaseStorage.instance.ref('profile_images/${widget.userId}.jpg');
              ...
              child: ConstrainedBox(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(formatDate(user['startDate']),
                        style: const TextStyle(
                      ...
                      StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                        ...
                        builder: (context, docSnap) {
                          ...
                          return ListTile(
                            ...
                            title: const Text("Assigned Doctor",
                                style: TextStyle(
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  _infoRow(Icons.home_work_outlined,
  ...
  Widget _buildContactSection(Map<String, dynamic> user) => Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text("Contact & Emergency Information",
              style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
          const SizedBox(height: 12),
          Row(
            children: [
              Expanded(
                  child: _buildTitled("Emergency Contact",
                      user['emergencyContactName'] ?? 'N/A')),
              const SizedBox(width: 16),
              Expanded(
                  child: _buildTitled(
                      "Contact Number", user['emergencyContactNumber'] ?? 'N/A')),
            ],
          ),
          const SizedBox(height: 12),
